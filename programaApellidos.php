    ...
    switch ($elegir) {
        ...
        case 3:
            /** Mostrar el primer juego ganador*/
                ...
                $nombreGanador = strtoupper(trim(fgets(STDIN)));
                $numeroDeGanador = primerGanador($juegosTotal, $nombreGanador);
                if ($numeroDeGanador != -1) {
                    echo datosDelJuego($numeroDeGanador, $juegosTotal);
                } else {
